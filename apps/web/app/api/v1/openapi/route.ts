  ...
  request: {
    params: z.object({
      groupId: z
        .string()
        .describe(
          "You can find the group id by going to `https://www.getbntly.com/automation?tab=groups`, clicking `Matching Emails`, and then copying the id from the URL.",
        ),
    }),
