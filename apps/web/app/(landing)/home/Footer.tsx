...
const navigation = {
  features: [
    { name: "Smart Replies", href: "/ai-automation" },
    { name: "Inbox Cleanup", href: "/clean-inbox" },
    { name: "Bulk Unsubscribe", href: "/bulk-email-unsubscriber" },
    { name: "Cold Email Blocker", href: "/block-cold-emails" },
    { name: "Email Analytics", href: "/email-analytics" },
  ],
  useCases: [
    { name: "Busy Professionals", href: "/professionals" },
    { name: "Freelancers", href: "/freelancers" },
    { name: "Creators", href: "/creator" },
    { name: "Students", href: "/students" },
    { name: "Small Business Owners", href: "/small-business" },
  ],
  support: [
  ...
  company: [
    { name: "Blog", href: "/blog" },
    { name: "Twitter", href: "https://twitter.com/bntlyapp", target: "_blank" },
  ...
  social: [
    {
      name: "Twitter",
      href: "https://twitter.com/bntlyapp",
      target: "_blank",
      icon: (props: any) => (
    ...
    <footer className="relative z-50">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <div className="mt-16 grid grid-cols-2 gap-8 lg:grid-cols-5 xl:col-span-2 xl:mt-0">
          <div>
            <FooterList title="Features" items={navigation.features} />
          </div>
          <div>
