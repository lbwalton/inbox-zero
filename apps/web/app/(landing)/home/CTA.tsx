    ...
    <div className="relative -z-10 mt-12 px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="font-cal text-3xl text-gray-900 sm:text-4xl">
          ...
          <br />
          Start using Bntly today.
        </h2>
        <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-600">
          Bntly uses AI to help you empty your inbox daily. What previously took
          hours, now takes minutes. Bntly is your virtual assistant for emails.
        </p>
        <CTAComponent />
      </div>
      {/* <div
