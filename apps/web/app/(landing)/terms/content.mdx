Subject to these Terms of Service (this "Agreement"), [getbntly.com](/) ("Bntly", "we", "us" and/or "our") provides access to Bntly's cloud platform as a service (collectively, the "Services"). By using or accessing the Services, you acknowledge that you have read, understand, and agree to be bound by this Agreement.
...
By signing up and using the services provided by Bntly (referred to as the "Service"), you are agreeing to be bound by the following terms and conditions ("Terms of Service"). The Service is owned and operated by Bntly ("Us", "We", or "Our").

## 2. Description of Service

Bntly provides an email management tool ("the Product"). The Product is accessible at getbntly.com and other domains and subdomains controlled by Us (collectively, "the Website").
...
Questions or comments about the Website or these Terms of Service may be directed to our support team at support@getbntly.com.
